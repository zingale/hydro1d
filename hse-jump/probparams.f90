...
module probparams_module
  ...
  real (kind=dp_t), save :: delta = 0.125_dp_t
  real (kind=dp_t), save :: x_jump = 0.5_dp_t
  real (kind=dp_t), save :: e_factor = 2.0_dp_t

  ! namelist
  namelist /problem/ pres_base, dens_base, small_dens, delta, x_jump, e_factor
