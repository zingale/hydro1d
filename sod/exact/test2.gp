...
set ylabel "density";
plot 'test2_000075.ppm' using 1:2 notitle with points lc 7,\
     'test2-exact.out' using 1:2 notitle with lines ls -1 lc 0;

set origin 0.0, 0.333;
set ylabel "velocity";
plot 'test2_000075.ppm' using 1:5 notitle with points lc 7,\
     'test2-exact.out' using 1:3 notitle with lines ls -1 lc 0;

set origin 0.0, 0.0;
set ylabel "pressure";
plot 'test2_000075.ppm' using 1:6 notitle with points lc 7,\
